<template>
  ...
  >
    <div class="container">
      <div class="row">
        <div class="form-wrap  col-md-6 mb-4">
          <div class="section-header mb-5 ">
            ...
            <p>
              ...
              Placeat ea quam laborum, ducimus, laboriosam sint dolorum aspernatur libero
            </p>
          </div>
          <div
          ...
          >
            ...
            <div class="form-group  col-md-12">
              <button
                type="submit"
                class="btn btn-block form-submit-button btn-large btn-gradient"
              >
                Send
                message
              </button>
